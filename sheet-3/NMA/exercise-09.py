...
def possible_amount_bread(inventory, recipe):
    ...
    """
    p_a_flour = inventory['Flour'] // recipe['Flour']   # p_a_... stands for possible_amount and means the amount of
    p_a_salt = inventory['Salt'] // recipe['Salt']      # bread you could bake with this ingredient
    p_a_yeast = inventory['Yeast'] // recipe['Yeast']

    return min(p_a_flour, p_a_salt, p_a_yeast)
...
def bake_breads(amount, inventory, recipe):
    ...
    :return: None
    """
    inventory['Flour'] -= amount * recipe['Flour']
    inventory['Salt'] -= amount * recipe['Salt']
    inventory['Yeast'] -= amount * recipe['Yeast']
